    ...
    <div className="container">
      ...
      {/* slider === 1 ? (
        ...
        {slider === 2 ? (
          ...
          <h2 style={{ background: "none", marginBottom: ".5em" }}>Marvel</h2>
        ) : slider === 4 ? (
          <h2 style={{ background: "none", marginBottom: ".5em" }}>Weather</h2>
        ) : slider === 5 ? (
          <h2 style={{ background: "none", marginBottom: ".5em" }}>Movies</h2>
        ) : slider === 6 ? (
          <h2 style={{ background: "none", marginBottom: ".5em" }}>
            Rick and Morty
          </h2>
        ...
        <div>
          ...
          <button className="buttonSelection" onClick={() => setSlider(3)}>
            3
          </button>
          <button className="buttonSelection" onClick={() => setSlider(4)}>
            4
          </button>
          <button className="buttonSelection" onClick={() => setSlider(5)}>
            5
          </button>
